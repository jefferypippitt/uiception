...
summary: Today we're shipping templates, full Next.js starters you install with shadcn init, beginning with a minimal portfolio for developers, writers and personal projects.
date: 2026-07-19
items:
  - name: portfolio-v1
    label: Portfolio v1
