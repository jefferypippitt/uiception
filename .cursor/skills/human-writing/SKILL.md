...
Apply these rules when writing, editing, or reviewing documentation, README copy, changelogs, or other instructional prose in this repository:
...
- Use descriptive link text and placeholders such as `your_access_token_here`. Avoid bare URLs, "click here", and unexplained values.
...
5. Read [eval.md](eval.md) completely and check the result against it. Revise any failure before responding.
