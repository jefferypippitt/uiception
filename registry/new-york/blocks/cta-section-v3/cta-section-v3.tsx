...
import { CtaSectionV3DitherBg } from "./components/cta-section-v3-dither-bg"
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-4">
        <div className="cta-v3-box relative overflow-hidden rounded-none border">
          ...
          <div className="relative z-10 flex max-w-2xl flex-col items-start gap-5 px-6 py-8 text-left sm:gap-6 md:px-10 md:py-10 lg:px-12 lg:py-12">
            ...
            <p className="max-w-md text-lg font-normal leading-relaxed text-zinc-300 motion-reduce:text-muted-foreground">
              Install in one sitting. Keep the same APIs when you push to production.
            </p>
