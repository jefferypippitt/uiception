...
/** Swap for your routes after installing this block (e.g. `/contact`, `/demo`). */
const PRIMARY_HREF = "#"
...
export default function CtaButtons() {
  ...
  return (
    <div className="flex flex-row flex-wrap justify-center gap-3">
      ...
      {/* Primary: curtain reveal — enters from top on hover, from bottom on unhover */}
      <Button size="lg" className="group relative overflow-hidden" asChild>
        <Link href={PRIMARY_HREF}>
          {/* Default layer: visible at rest, exits downward on hover */}
          ...
          {/* Hover layer: hidden above, slides down into view on hover */}
          ...
          {/* Spacer: locks button dimensions */}
          <span className="invisible">Book a free call</span>
        </Link>
      </Button>

      {/* Secondary: char-by-char delete, play icon moves to center and grows */}
      <Button
        variant="outline"
        size="lg"
      ...
      >
        ...
        >
        {/* Text layer — chars disappear right-to-left, layout space preserved */}
        ...
        {/* Icon layer — enters from right, moves to center and springs to full size */}
        <CirclePlay
          size={18}
